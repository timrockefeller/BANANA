...
在编写代码的时候，如果拥有一个跨平台的文本编辑器。具有简洁直观的图形用户界面，同时能够进行简单的高亮提示。在多个平台都能使用到相似的界面和服务，包括代码语法高亮，自动补全和其他周边功能。使得编码过程不再机械枯燥，提高用户的编码体验。

### 1.1 标识

本系统计划适用于Windows/Linux/OS X操作系统下安装及使用。

文件状态： 报告编号 跨平台文件编辑器开发企划书

- [    ]  草稿 Banana-001
- [ √ ]  正式发布 当前版本 V1.0
- [    ]  正在修改 编写人 许文瑞 许晨阳 杨帅 黄子闻 翁韬

 编写日期 2020-4-25 审批人 Banana代码编辑器开发小组 审批日期 2020-4-27
...
通过本次项目开发，深入了解跨平台文本编辑器的开发内容和运行过程，将所学的开发技术运行到项目中去，运用到Electron框架进行运行环境支撑，在编写中使用Vue.js框架，提高基于JavaScript前端的开发效率。

### 1.4 与其他计划之间的关系

提前进行软件开发计划书以及需求规格说明书的撰写。在设计阶段完成概要设计说明书、详细设计说明书；此后完成编码及测试阶段，其间撰写软件测试计划并依照其进行软件测试，并完成测试分析报告。在开发过程的末尾，撰写项目开发总结报告，同时编辑用户手册，以供用户学习使用。
...
![模块设计图](https://images.gitee.com/uploads/images/2020/0426/115627_0c76b157_7414702.png "屏幕截图.png")
...
1. 系统要求：Window, Linux 或 Mac OS X
2. 开发工具：VS Code、Typora
3. 运行环境：要求系统具有Node.js 12的运行环境
...
![image-20200427152901688](C:\Users\xuwenrui\AppData\Roaming\Typora\typora-user-images\image-20200427152901688.png)
...
本文档撰写参考文档格式：[GB T-8567-2006 软件工程相关文档综合实例集](https://wenku.baidu.com/view/a1f1269903d276a20029bd64783e0912a2167c8b.html)
